                    ...
                    put("properties", JSONObject().apply {
                        put("action", JSONObject().apply {
                            ...
                            put("enum", JSONArray(listOf(
                                "open_app", "click_text", "long_click_text", "click_description", "type_text", "wait", "press_enter",
...
Use wait only for short UI stabilization between actions, with value in milliseconds from 50 to 1500.
Available actions: open apps; visible text/content-description click; long click; type; wait; press enter;
